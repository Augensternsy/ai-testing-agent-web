  ...
  return (
    <nav className="navbar">
      <div className="navbar-inner">
        <div className="navbar-brand">AI Testing <span>Agent</span></div>
        <div className="navbar-links">
          ...
          <button
            ...
            aria-label={language === 'en' ? t.lang.switch : t.lang.switchTo}
            title={language === 'en' ? t.lang.switch : t.lang.switchTo}
          >
            🌐 {language === 'en' ? '中文' : 'EN'}
          </button>
