  ...
  return (
    <section className="hero" id="overview">
      <div className="container">
        <h1>AI Agent Automated <span className="gradient">Testing Platform</span></h1>
        <p className="hero-subtitle">RAG + DeepSeek powered API testing pipeline</p>
        <p className="hero-desc">
          Automatically transform OpenAPI specifications into structured test cases,
          executable PyTest scripts, test reports, and controlled repair loops.
        </p>
